...
<body>
    ...
    <div class="container-scroller">
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form action="addmot.php" method="POST">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> اسم المستودع</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="name">

                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">موقع المستودع</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="" name="locetion">
                                        </div>


                                        <button type="submit" class="btn btn-danger" name="submit">إضافة</button>
                                    </form>
        ...
        if (isset($_POST['submit'])) {
            $name = $_POST['name'];
            $locetion = $_POST['locetion'];
            $sql = "insert into warehouse(name, locetion)
    values('$name', '$locetion')";
