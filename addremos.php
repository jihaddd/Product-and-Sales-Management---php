                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form action="addremos.php" class="forms" method="POST" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-bordered">
                                        <form action="addremos.php" class="forms" method="POST">
                                        <thead>
                                            <tr>
                                                <th> # </th>
                                                <th> الصنف </th>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['search'])) {
                                                $search = $_POST['search'];
                                                $query = "select id, product, Quantity, most, Section, xxx, bia, phone from test where num='" . $search . "' ";
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo '<td><input type="text" value="' . $row['Section'] . '"  name="Section" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" readonly></td>';
                                                    ...
                                                    echo '<td><input type="text" value="' . $row['phone'] . '"  name="phone" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" readonly></td>';
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    $sql = "insert into remost(Product, Quantity, most, section, xxx, bia, phon, shahen, bolisa)
                                     values('$Product', '$Quantity', '$most', '$Section', '$xxx', '$bia', '$phone', '$shahen', '$bolisa')";
                                    mysqli_query($conn, $sql);
                                    echo '<input type="text" value="قيمة الشحن على العميل وخلال 10 أيام عمل سوف يتم تحويل المبلغ للعميل " class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" readonly>';
